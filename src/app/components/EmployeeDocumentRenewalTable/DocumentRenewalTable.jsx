          ...
          },
          {
            ...
            Cell: ({ cell }) => {
              ...
              return (
                ...
                >
                  <span className={`badge ${badgeClass} fs-7 fw-bold`}>{value?.toString().slice(1)}</span>
                </Box>
              );
            }
          }
...
// export type EmployeeDocumentRenewalDetails = {
//     name: string
//     Documentname: string
...
// const RenewalStatusTable = () => {
//   const columns = useMemo<MRT_ColumnDef<EmployeeDocumentRenewalDetails>[]>(
//     () => [
//     {
//         id: 'nameofPerson', //id used to define `group` column
//         header: 'Name',
//         columns: [
//             {
//                 header: 'Name',
...
//     },
//     {
//         id: 'document', //id used to define `group` column
//         header: 'Document',
//         columns: [
//             {
//                 id: 'documentName',
